...
$data = $sql->getAll("SELECT DISTINCT U.id,U.name,U.email,U.phone,C.name as city_name,U.sex,U.job_status,U.edu_institution,U.company, GROUP_CONCAT(DISTINCT G.name SEPARATOR ',') AS groups $select
		FROM `User` U 
